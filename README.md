...
through the installed skill. The test supplies a private temporary companion
state root so the nested Codex sandbox can write job state. Sonnet is used only
for this small routing test.
